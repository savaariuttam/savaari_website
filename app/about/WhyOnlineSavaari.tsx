...
const sections = [
  ...
  {
    icon: "path/to/fun_at_work_icon.png",
    title: "Fun @ Work",
  ...
  {
    icon: "path/to/open_culture_icon.png",
    title: "Open Culture",
...
const WhyOnlineSavaari = () => {
  return (
    <div className="flex flex-col items-center py-10">
      ...
      <p className="text-center max-w-lg mb-10">
